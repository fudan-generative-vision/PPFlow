...
"""
Sample new images from a pre-trained PPFlow model.
"""
import torch
...
def main(mode, args):
    ...
    if args.ckpt is None:
        assert args.model == "PPFlow_XL_2" or "PPFlow_XL_3"
...
if __name__ == "__main__":
    ...
    parser.add_argument("--cfg-scales", type=float, nargs='+', default=[3.0, 4.0],
